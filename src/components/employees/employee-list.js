...
import '../ui/confirmation-modal.js' // Import the modal component
import { t } from '../../localization/localization.js' // Import t
import './employee-card.js' // Import the new card component
import '../ui/pagination-controls.js' // Import the new pagination component
...
class EmployeeList extends LitElement {
	...
	_renderListView() {
		...
		if (employeesToRender.length === 0) {
			return html`
				<div class="no-results">${t('noEmployeesFound')}</div>
			`
		}
