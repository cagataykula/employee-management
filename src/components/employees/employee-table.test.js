...
// Expected formatted dates using our utils formatDate (DD/MM/YYYY format)
const expectedFormattedDate1Emp = formatDate(mockEmployees[0].dateOfEmployment) // '15/01/2023'
const expectedFormattedDate1Birth = formatDate(mockEmployees[0].dateOfBirth) // '20/05/1990'
const expectedFormattedDate2Emp = formatDate(mockEmployees[1].dateOfEmployment) // '01/08/2022'
const expectedFormattedDate2Birth = formatDate(mockEmployees[1].dateOfBirth) // '30/11/1992'
...
describe('EmployeeTable', () => {
	...
	it('should display employee data accurately in cells', async () => {
		...
		expect(getCell(row1, 3)?.textContent.trim()).toBe(expectedFormattedDate1Emp)
		...
		expect(getCell(row2, 3)?.textContent.trim()).toBe(expectedFormattedDate2Emp)
